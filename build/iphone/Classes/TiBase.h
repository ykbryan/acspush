...
// in simulator we redefine to format for acspush Developer console
...
{\
	NSString * exceptionName = [@"org.acspush." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.acspush";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIacspushNativeItemNone = -1, 
	UIacspushNativeItemSpinner = -2,
	UIacspushNativeItemProgressBar = -3,
	
	UIacspushNativeItemSlider = -4,
	UIacspushNativeItemSwitch = -5,
	UIacspushNativeItemMultiButton = -6,
	UIacspushNativeItemSegmented = -7,
	
	UIacspushNativeItemTextView = -8,
	UIacspushNativeItemTextField = -9,
	UIacspushNativeItemSearchBar = -10,
	
	UIacspushNativeItemPicker = -11,
	UIacspushNativeItemDatePicker = -12,
	
	UIacspushNativeItemInfoLight = -13,
	UIacspushNativeItemInfoDark = -14,
	
	UIacspushNativeItemDisclosure = -15,
	
	UIacspushNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all acspush instances of
