 ...
 * Copyright (c) 2009-2011 by acspush, Inc. All Rights Reserved.
...
//@interface acspushObject : NSObject
//@end

@interface acspushObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[acspushObject class]])
		{
			for (NSString *key in [[(acspushObject*)o modules] allKeys])
			{
