...
/**
 The base class for all acspush modules
 */
...
/**
 acspush Platform calls this method on startup.
 */
-(void)startup;

/**
 acspush Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 acspush Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 acspush Platform calls this method on resume.
 @param sender The sender of the event.
 */
